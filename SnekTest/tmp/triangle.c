...
void _main_F0(){
	...
	for(int i=0;i<3;i++){
		struct Vertex* const _27=&vertexData[i];
		const struct vec3 _28={0.0,0.5,0};
		const struct vec4 _29={1,0,0,1};
		const struct Vertex _30={_28,_29};
		const struct vec3 _31={-0.5,-0.5,0};
		const struct vec4 _32={1,1,0,1};
		const struct Vertex _33={_31,_32};
		const struct vec3 _34={0.5,-0.5,0};
		const struct vec4 _35={1,0,1,1};
		const struct Vertex _36={_34,_35};
		const A3SVertex _37={_30,_33,_36};
		__bounds_check(i>=0&&i<3,"triangle.src",68,19);
		struct Vertex* const _38=&_37.data[i];
		(*_27)=(*_38);
	}
	SDL_UnmapGPUTransferBuffer(device,transferBuffer);
	struct SDL_GPUCommandBuffer* const _39=SDL_AcquireGPUCommandBuffer(device);
	struct SDL_GPUCommandBuffer* cmdBuffer=_39;
	struct SDL_GPUCopyPass* const _40=SDL_BeginGPUCopyPass(cmdBuffer);
	struct SDL_GPUCopyPass* copyPass=_40;
	struct SDL_GPUTransferBufferLocation src={0};
	struct SDL_GPUTransferBuffer** const _41=&src.transfer_buffer;
	(*_41)=transferBuffer;
	struct SDL_GPUBufferRegion dst={0};
	struct SDL_GPUBuffer** const _42=&dst.buffer;
	(*_42)=vertexBuffer;
	Uint32* const _43=&dst.size;
	const u64 _44=(u64)sizeof(A3SVertex);
	const u32 _45=(u32)_44;
	const Uint32 _46=(Uint32)_45;
	(*_43)=_46;
	struct SDL_GPUTransferBufferLocation* const _47=&src;
	struct SDL_GPUBufferRegion* const _48=&dst;
	SDL_UploadToGPUBuffer(copyPass,_47,_48,true);
	SDL_EndGPUCopyPass(copyPass);
	const bool _49=SDL_SubmitGPUCommandBuffer(cmdBuffer);
	const string _50={_G3,21};
	struct SDL_GPUShader* const _51=_loadShader_F3stESDL_GPUShaderStagepSSDL_GPUDevice_pSSDL_GPUShader(_50,0,device);
	struct SDL_GPUShader* vertexShader=_51;
	const string _52={_G4,21};
	struct SDL_GPUShader* const _53=_loadShader_F3stESDL_GPUShaderStagepSSDL_GPUDevice_pSSDL_GPUShader(_52,1,device);
	struct SDL_GPUShader* fragmentShader=_53;
	A1SSDL_GPUVertexBufferDescription vertexBufferDescriptions={0};
	__bounds_check(0>=0&&0<1,"triangle.src",91,2);
	struct SDL_GPUVertexBufferDescription* const _54=&vertexBufferDescriptions.data[0];
	Uint32* const _55=&(*_54).slot;
	const Uint32 _56=(Uint32)0u;
	(*_55)=_56;
	__bounds_check(0>=0&&0<1,"triangle.src",92,2);
	struct SDL_GPUVertexBufferDescription* const _57=&vertexBufferDescriptions.data[0];
	enum SDL_GPUVertexInputRate* const _58=&(*_57).input_rate;
	(*_58)=0;
	__bounds_check(0>=0&&0<1,"triangle.src",93,2);
	struct SDL_GPUVertexBufferDescription* const _59=&vertexBufferDescriptions.data[0];
	Uint32* const _60=&(*_59).instance_step_rate;
	const Uint32 _61=(Uint32)0u;
	(*_60)=_61;
	__bounds_check(0>=0&&0<1,"triangle.src",94,2);
	struct SDL_GPUVertexBufferDescription* const _62=&vertexBufferDescriptions.data[0];
	Uint32* const _63=&(*_62).pitch;
	const u64 _64=(u64)sizeof(struct Vertex);
	const u32 _65=(u32)_64;
	const Uint32 _66=(Uint32)_65;
	(*_63)=_66;
	A2SSDL_GPUVertexAttribute attributes={0};
	__bounds_check(0>=0&&0<2,"triangle.src",97,2);
	struct SDL_GPUVertexAttribute* const _67=&attributes.data[0];
	Uint32* const _68=&(*_67).buffer_slot;
	const Uint32 _69=(Uint32)0u;
	(*_68)=_69;
	__bounds_check(0>=0&&0<2,"triangle.src",98,2);
	struct SDL_GPUVertexAttribute* const _70=&attributes.data[0];
	Uint32* const _71=&(*_70).location;
	const Uint32 _72=(Uint32)0u;
	(*_71)=_72;
	__bounds_check(0>=0&&0<2,"triangle.src",99,2);
	struct SDL_GPUVertexAttribute* const _73=&attributes.data[0];
	enum SDL_GPUVertexElementFormat* const _74=&(*_73).format;
	(*_74)=11;
	__bounds_check(0>=0&&0<2,"triangle.src",100,2);
	struct SDL_GPUVertexAttribute* const _75=&attributes.data[0];
	Uint32* const _76=&(*_75).offset;
	const Uint32 _77=(Uint32)0u;
	(*_76)=_77;
	__bounds_check(1>=0&&1<2,"triangle.src",101,2);
	struct SDL_GPUVertexAttribute* const _78=&attributes.data[1];
	Uint32* const _79=&(*_78).buffer_slot;
	const Uint32 _80=(Uint32)0u;
	(*_79)=_80;
	__bounds_check(1>=0&&1<2,"triangle.src",102,2);
	struct SDL_GPUVertexAttribute* const _81=&attributes.data[1];
	Uint32* const _82=&(*_81).location;
	const Uint32 _83=(Uint32)1u;
	(*_82)=_83;
	__bounds_check(1>=0&&1<2,"triangle.src",103,2);
	struct SDL_GPUVertexAttribute* const _84=&attributes.data[1];
	enum SDL_GPUVertexElementFormat* const _85=&(*_84).format;
	(*_85)=12;
	__bounds_check(1>=0&&1<2,"triangle.src",104,2);
	struct SDL_GPUVertexAttribute* const _86=&attributes.data[1];
	Uint32* const _87=&(*_86).offset;
	const u64 _88=(u64)sizeof(struct vec3);
	const u32 _89=(u32)_88;
	const Uint32 _90=(Uint32)_89;
	(*_87)=_90;
	A1SSDL_GPUColorTargetDescription targets={0};
	__bounds_check(0>=0&&0<1,"triangle.src",107,2);
	struct SDL_GPUColorTargetDescription* const _91=&targets.data[0];
	enum SDL_GPUTextureFormat* const _92=&(*_91).format;
	const enum SDL_GPUTextureFormat _93=SDL_GetGPUSwapchainTextureFormat(device,window);
	(*_92)=_93;
	__bounds_check(0>=0&&0<1,"triangle.src",108,2);
	struct SDL_GPUColorTargetDescription* const _94=&targets.data[0];
	struct SDL_GPUColorTargetBlendState* const _95=&(*_94).blend_state;
	const struct SDL_GPUColorTargetBlendState _96=_createOpaqueBlendState_F0_SSDL_GPUColorTargetBlendState();
	(*_95)=_96;
	struct SDL_GPUGraphicsPipelineCreateInfo pipelineInfo={0};
	struct SDL_GPUShader** const _97=&pipelineInfo.vertex_shader;
	(*_97)=vertexShader;
	struct SDL_GPUShader** const _98=&pipelineInfo.fragment_shader;
	(*_98)=fragmentShader;
	enum SDL_GPUPrimitiveType* const _99=&pipelineInfo.primitive_type;
	(*_99)=0;
	struct SDL_GPUVertexInputState* const _100=&pipelineInfo.vertex_input_state;
	Uint32* const _101=&(*_100).num_vertex_buffers;
	const Uint32 _102=(Uint32)1u;
	(*_101)=_102;
	struct SDL_GPUVertexInputState* const _103=&pipelineInfo.vertex_input_state;
	struct SDL_GPUVertexBufferDescription** const _104=&(*_103).vertex_buffer_descriptions;
	__bounds_check(0>=0&&0<1,"triangle.src",115,64);
	struct SDL_GPUVertexBufferDescription* const _105=&vertexBufferDescriptions.data[0];
	struct SDL_GPUVertexBufferDescription* const _106=&(*_105);
	(*_104)=_106;
	struct SDL_GPUVertexInputState* const _107=&pipelineInfo.vertex_input_state;
	Uint32* const _108=&(*_107).num_vertex_attributes;
	const Uint32 _109=(Uint32)2u;
	(*_108)=_109;
	struct SDL_GPUVertexInputState* const _110=&pipelineInfo.vertex_input_state;
	struct SDL_GPUVertexAttribute** const _111=&(*_110).vertex_attributes;
	__bounds_check(0>=0&&0<2,"triangle.src",117,55);
	struct SDL_GPUVertexAttribute* const _112=&attributes.data[0];
	struct SDL_GPUVertexAttribute* const _113=&(*_112);
	(*_111)=_113;
	struct SDL_GPUGraphicsPipelineTargetInfo* const _114=&pipelineInfo.target_info;
	Uint32* const _115=&(*_114).num_color_targets;
	const Uint32 _116=(Uint32)1u;
	(*_115)=_116;
	struct SDL_GPUGraphicsPipelineTargetInfo* const _117=&pipelineInfo.target_info;
	struct SDL_GPUColorTargetDescription** const _118=&(*_117).color_target_descriptions;
	__bounds_check(0>=0&&0<1,"triangle.src",119,56);
	struct SDL_GPUColorTargetDescription* const _119=&targets.data[0];
	struct SDL_GPUColorTargetDescription* const _120=&(*_119);
	(*_118)=_120;
	struct SDL_GPUGraphicsPipelineCreateInfo* const _121=&pipelineInfo;
	struct SDL_GPUGraphicsPipeline* const _122=SDL_CreateGPUGraphicsPipeline(device,_121);
	struct SDL_GPUGraphicsPipeline* pipeline=_122;
	...
	while(1){
		...
		while(1){
			union SDL_Event* const _123=&event;
			const bool _124=SDL_PollEvent(_123);
			if(!_124)break;
			Uint32* const _125=&event.type;
			const enum SDL_EventType _126=(enum SDL_EventType)(*_125);
			const bool _127=_126==256;
			if(_127){
				running=false;
			}
		}
		struct SDL_GPUCommandBuffer* const _128=SDL_AcquireGPUCommandBuffer(device);
		struct SDL_GPUCommandBuffer* cmdBuffer=_128;
		struct SDL_GPUTexture* swapchain={0};
		u32 width={0};
		u32 height={0};
		struct SDL_GPUTexture** const _129=&swapchain;
		u32* const _130=&width;
		Uint32* const _131=(Uint32*)_130;
		u32* const _132=&height;
		Uint32* const _133=(Uint32*)_132;
		const bool _134=SDL_WaitAndAcquireGPUSwapchainTexture(cmdBuffer,window,_129,_131,_133);
		struct SDL_GPUColorTargetInfo colorTarget={0};
		struct SDL_FColor* const _135=&colorTarget.clear_color;
		const struct SDL_FColor _136={0.8,0.8,0.8,1.0};
		(*_135)=_136;
		enum SDL_GPULoadOp* const _137=&colorTarget.load_op;
		(*_137)=1;
		enum SDL_GPUStoreOp* const _138=&colorTarget.store_op;
		(*_138)=0;
		struct SDL_GPUTexture** const _139=&colorTarget.texture;
		(*_139)=swapchain;
		struct SDL_GPUColorTargetInfo* const _140=&colorTarget;
		const Uint32 _141=(Uint32)1u;
		struct SDL_GPURenderPass* const _142=SDL_BeginGPURenderPass(cmdBuffer,_140,_141,0);
		struct SDL_GPURenderPass* renderPass=_142;
		SDL_BindGPUGraphicsPipeline(renderPass,pipeline);
		A1SSDL_GPUBufferBinding bufferBindings={0};
		__bounds_check(0>=0&&0<1,"triangle.src",152,3);
		struct SDL_GPUBufferBinding* const _143=&bufferBindings.data[0];
		struct SDL_GPUBuffer** const _144=&(*_143).buffer;
		(*_144)=vertexBuffer;
		__bounds_check(0>=0&&0<1,"triangle.src",153,3);
		struct SDL_GPUBufferBinding* const _145=&bufferBindings.data[0];
		Uint32* const _146=&(*_145).offset;
		const Uint32 _147=(Uint32)0u;
		(*_146)=_147;
		const Uint32 _148=(Uint32)0u;
		struct SDL_GPUBufferBinding* const _149=bufferBindings.data;
		const Uint32 _150=(Uint32)1u;
		SDL_BindGPUVertexBuffers(renderPass,_148,_149,_150);
		const Uint32 _151=(Uint32)3u;
		const Uint32 _152=(Uint32)1u;
		const Uint32 _153=(Uint32)0u;
		const Uint32 _154=(Uint32)0u;
		SDL_DrawGPUPrimitives(renderPass,_151,_152,_153,_154);
		SDL_EndGPURenderPass(renderPass);
		const bool _155=SDL_SubmitGPUCommandBuffer(cmdBuffer);
	}
