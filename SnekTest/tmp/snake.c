...
void _main_0(){
	...
	const SDL_WindowFlags _4=(SDL_WindowFlags)0llu;
	struct SDL_Window** const _5=&window;
	struct SDL_Renderer** const _6=&renderer;
	const bool _7=SDL_CreateWindowAndRenderer(_G1,1280,720,_4,_5,_6);
	const bool _8=!_7;
	if(_8){
		return;
	}
	...
	while(1){
		...
		const Uint8 _14=(Uint8)100u;
		const Uint8 _15=(Uint8)149u;
		const Uint8 _16=(Uint8)237u;
